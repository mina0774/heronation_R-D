    ...
    public void compare_product_size_with_body(){
        ...
        request.enqueue(new Callback<CompareWithWardrobe>() {
            ...
            public void onResponse(Call<CompareWithWardrobe> call, Response<CompareWithWardrobe> response) {
                ...
                switch(max_num){
                    case 0: view_size_S(compareWithWardrobe); recommendation_size_textview.setText("S size "); break;
                    case 1: view_size_M(compareWithWardrobe); recommendation_size_textview.setText("M size "); break;
                    case 2: view_size_L(compareWithWardrobe); recommendation_size_textview.setText("L size "); break;
                    case 3: view_size_XL(compareWithWardrobe); recommendation_size_textview.setText("XL size "); break;
                }
