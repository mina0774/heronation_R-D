...
public class MeasurementBodyActivity extends AppCompatActivity {
    ...
    public static MeasurementBodyActivity measurementBodyActivity;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_measurement_body);
        measurementBodyActivity=MeasurementBodyActivity.this;
    ...
    public void get_measurement_default_value(){
        ...
        Call<BodySizeLevel> request= getMeasurementDefaultValueService.GetMeasurementDefaultValue(gender,age,height,weight,authorization,accept);
        ...
        request.enqueue(new Callback<UserMyInfo>() {
            ...
            public void onResponse(Call<UserMyInfo> call, Response<UserMyInfo> response) {
                if (response.code()==200) {
                    ...
                    Intent intent=new Intent(MeasurementBodyActivity.this, IntroActivity.class);
