...
public class MeasurementResultActivity extends AppCompatActivity {
    ...
    public static ArrayList<Double> measurement_items_distance=MeasurementARActivity.measurement_items_distance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<MeasureItem.size();i++){
            String distanceString=String.format(Locale.getDefault(),"%.2f",measurement_items_distance.get(i)*100)+"cm";
